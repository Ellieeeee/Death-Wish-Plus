Hooks:Add("NetworkManagerOnPeerAdded", "NetworkManagerOnPeerAdded_DW", function(peer, peer_id)
	if Network:is_server() then
		DelayedCalls:Add("DelayedWarnModBB" .. tostring(peer_id), 2, function()
			local message = "Host is running 'Death Wish+.' This is a custom difficulty intended to replicated Overkill 145+. It is not recommended for players unfamiliar with Death Wish."
