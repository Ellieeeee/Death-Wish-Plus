...
function CharacterTweakData:init(tweak_data, presets)
    old_init(self, tweak_data, presets)
		self.tank.crouch_move = false --change this to true for sneaky dozers
		...
		self.phalanx_vip.LOWER_HEALTH_PERCENTAGE_LIMIT = 0
...
function CharacterTweakData:_init_taser(presets)
	...
	self.taser.weapon = {
		m4 = {
			aim_delay = {0, 0},
			focus_delay = 0,
			focus_dis = 200000000000000000000000000,
			spread = 0,
			miss_dis = 400000000000000000000000000000000000,
			RELOAD_SPEED = 0.66,
			melee_speed = 0.5,
			melee_dmg = 10,
...
function CharacterTweakData:_set_overkill_290()
	...
	self.phalanx_minion.HEALTH_INIT = 50
